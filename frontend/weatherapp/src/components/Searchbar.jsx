      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="bg-gray-800/50 backdrop-blur-md rounded-2xl p-8 border border-gray-700/50 shadow-2xl">
            ...
            <p className="text-gray-300 text-lg">Get real-time weather updates</p>
          </div>
        </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-md rounded-2xl shadow-2xl p-6 border border-gray-700/50">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                {weather.forecast?.map((day, i) => (
                  <div key={i} className="bg-gray-700/50 hover:bg-gray-700/70 rounded-xl p-4 border border-gray-600/50 transition-all duration-200 hover:scale-105">
                    <div className="text-sm font-semibold text-white mb-2">{day.date}</div>
                    <div className="text-xs text-gray-300 mb-3 line-clamp-2">{day.summary}</div>
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-blue-300 font-medium">{day.min}°C</span>
                      <span className="text-gray-500 mx-1">/</span>
                      <span className="text-red-300 font-medium">{day.max}°C</span>
                    </div>
                  </div>
                ))}
              </div>
